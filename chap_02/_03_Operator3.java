...
public class _03_Operator3 {
    public static void main(String[] args) {
        //비교 연산자
        System.out.println(5 > 3);//5는 3보다 크다 참이 트루
        System.out.println(5 >= 3);//5는 3보다 크거나 같다 트루
        System.out.println(5>=5);//5는 5보다 크거나 같다 트루
